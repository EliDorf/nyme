...
import NameSuggestion from '@/models/NameSuggestion'; // Adjust the import path as needed
import { connectToDatabase } from '@/lib/mongoose'; // Assuming you have a function to connect to MongoDB
