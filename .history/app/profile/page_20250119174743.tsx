      ...
      <div className="flex min-h-screen bg-gradient-to-r from-purple-400 via-pink-500 to-red-500">
        ...
        <main className="ml-24 p-4 md:ml-64 md:p-8 w-full">
          ...
          <section className="profile flex flex-col gap-6">
            <div className="profile-balance bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 shadow-lg hover:shadow-2xl transition-shadow duration-300">
              <p className="text-2xl font-semibold text-gray-700 dark:text-gray-200">Credits Available</p>
              <div className="mt-4 flex items-center gap-4">
                <Image
                  ...
                  className="w-12 h-12"
                />
                <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-100">{user.creditBalance}</h2>
              </div>
            </div>

            <div className="profile-image-manipulation bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 shadow-lg hover:shadow-2xl transition-shadow duration-300">
              <p className="text-2xl font-semibold text-gray-700 dark:text-gray-200">Name History</p>
              <div className="mt-4 flex items-center gap-4">
                <Image
                  ...
                  className="w-12 h-12"
                />
                <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-100"> {/* Replace with actual data */}</h2>
              </div>
            </div>
          </section>
