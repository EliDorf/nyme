...
const Profile = async ({ searchParams }: ProfileProps) => {
  try {
      ...
      <div className="flex min-h-screen bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 dark:from-purple-900 dark:via-pink-800 dark:to-red-900">
        ...
        <main className="ml-0 p-4 md:ml-64 md:p-8 w-full max-w-7xl mx-auto">
          ...
          <section className="profile flex flex-col gap-6 max-w-lg mx-auto md:max-w-none">
            <div className="profile-balance bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 shadow-lg hover:shadow-2xl transition-shadow duration-300 text-center md:text-left">
          ...
          <section className="mt-8 md:mt-14 max-w-lg mx-auto md:max-w-none">
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 md:p-6 shadow-lg hover:shadow-2xl transition-shadow duration-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-full">
                {(availableDomains as DomainStatus[]).map((domain, index) => (
                  <div 
                    key={index} 
                    className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600 hover:shadow-lg transition-shadow duration-300 text-center md:text-left"
                  >
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 dark:from-purple-900 dark:via-pink-800 dark:to-red-900">
