              ...
              <Tabs defaultValue="available" className="space-y-4">
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                  <TabsList className="w-full sm:w-auto grid grid-cols-2 gap-2">
                    <TabsTrigger value="available" className="bg-green-100/80 px-3 py-2 w-full">
                      <div className="flex items-center justify-center gap-2">
                        <span className="text-green-700">Available</span>
                        <Badge variant="secondary" className="ml-1 bg-white/90 px-2 min-w-[2rem] text-center">
                          {availableDomains.length}
                        </Badge>
                      </div>
                    </TabsTrigger>
                    <TabsTrigger value="unavailable" className="bg-red-100/80 px-3 py-2 w-full">
                      <div className="flex items-center justify-center gap-2">
