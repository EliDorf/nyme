          ...
          <div className="mx-auto max-w-full space-y-2 md:space-y-4">
            ...
            {suggestions.length > 0 && (
              <Card className="overflow-hidden">
                ...
                <CardContent>
                <ScrollArea className="h-[80px] md:h-auto">
                  <div className="flex flex-nowrap gap-2 pb-2 md:flex-wrap md:pb-0">
                      {suggestions.map((suggestion) => (
                        <Button
                          key={suggestion}
                          variant="outline"
                          className="h-9 w-[160px] shrink-0 justify-start px-3 transition-all hover:shadow-md md:h-auto md:w-[calc(33.333%-0.667rem)] md:p-4 lg:w-[calc(25%-0.75rem)]"
                                onClick={() => {
                                  const userEmail = user?.primaryEmailAddress?.emailAddress;
