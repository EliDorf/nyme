...
import { trackSignupComplete, trackLogin } from '@/lib/analytics/dataLayer';
...
const AuthEvents = () => {
  ...
  useEffect(() => {
    ...
    const signupMethod = user.publicMetadata.signupMethod as string;
