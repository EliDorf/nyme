...
* @see https://v0.dev/t/Kb4Ak8pzDAR
    ...
    <aside className="fixed inset-y-0 left-0 z-10 flex h-full w-64 flex-col bg-background border-r border-muted">
      <div className="flex h-16 shrink-0 items-center justify-between px-4">
        <Link href="/" className="flex items-center gap-2 font-semibold" prefetch={false}>
          <Image src='/components/assets/output.png' alt='logo' width={180} height={28} />
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            <MountainIcon className="h-6 w-6" />
              <Image src=".../assets/placeholder.svg" width="32" height="32" className="rounded-full" alt="image" />
            </Button>
          </DropdownMenuTrigger>
